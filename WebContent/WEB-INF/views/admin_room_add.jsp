...
$(function () {
	...
	$("#insertBtn").click(function(){
		...
		if(confirm("룸을 추가하시겠습니까?")){
			$.ajax({
				url:"add_room_process.do",
				processData: false,
				contentType: false,
				data:formData,
				type:"post",
...
<div id="class4wrap">
	...
	<div id="container">
		...
		<div style="text-align: center; font-size: 23px; font-weight: bold;"> 공간(룸) 추가 </div>
		<br/>
		<br/>
		...
		<form id="roomFrm" enctype="multipart/form-data">
			<div style="width:700px;  min-height: 500px;float: right; margin-right: 150px;">
				<select style="width: 185px" id="concept_name" name="concept_name">
					<c:forEach var="data" items="${conceptName}">
						<option value="<c:out value="${data.concept_name}"/>"><c:out value="${data.concept_name}(${data.concept_name2})"/></option>
					</c:forEach>
				</select>
					<br/>
					<br/>
				<input type="text" id="room_name" name="room_name">
					<br/>
					<br/>
				<input type="text" id="room_name2" name="room_name2">
					<br/>
					<br/>
				<select style="width: 185px" id="person_num" name="person_num">
				...
				<input type="text" id="charge" name="charge">
					<br/>
					<br/>
				<input type="text" style="width: 445px" id="brief_info" name="brief_info">
					<br/>
					<br/>
				<textarea rows="10" cols="60" id="info" name="info"></textarea>
					<br/>
					<br/>
				...
				<img id="img3" name="img3"/>
					<br/>
					<br/>
			 	<div>
			  	<input class="btn btn-secondary" type="button" value="추가" style="margin-left: 10px;" id="insertBtn">
