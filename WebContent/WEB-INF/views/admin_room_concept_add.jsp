...
$(function () {
	...
	$("#cancelBtn").click(function(){
		if(confirm("작성을 취소하시겠습니까?\n취소하시면 작성하신 내용을 잃게 됩니다.")){
			/* history.back(); */
			location.replace("admin_room.do");
	...
	$("#insertBtn").click(function(){
		...
		if(confirm("컨셉을 추가하시겠습니까?")){
			$.ajax({
				url:"add_concept_process.do",
				processData: false,
				contentType: false,
				data:formData,
				type:"post",
...
<div id="class4wrap">
	...
	<div id="container">
		...
		<div style="text-align: center; font-size: 23px; font-weight: bold;"> 공간(컨셉) 추가 </div>
		<br/>
		<br/>
		...
		<form id="conceptFrm" enctype="multipart/form-data">
			<div style="width:700px;  min-height: 500px;float: right; margin-right: 150px;">
				<input type="text" name="concept_name" id="concept_name">
					<br/>
					<br/>
				<input type="text" name="concept_name2" id="concept_name2">
					<br/>
					<br/>
				<input type="text" style="width: 445px" name="brief_info" id="brief_info">
					<br/>
					<br/>
				<textarea rows="10" cols="60" name="info" id="info"></textarea>
					<br/>
					<br/>
